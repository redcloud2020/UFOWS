package com.uni.ufows.security;
...
public class SecurePreferences {
    ...
    public static SecurePreferences getInstance(Context context) {
        if (instance == null) {
            instance = new SecurePreferences(context, "ufow_pref", "UfOwPrefPassWord123123123", true);
        }
        return instance;
    }
     ...
     *                       Hardcoding your key in the application is bad, but better than plaintext preferences. Having the Users enter the key upon application launch is a safe(r) alternative, but annoying to the Users.
